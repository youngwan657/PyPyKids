...
"""
    ...
    explanation = RichTextField(default=default_explanation, blank=True)
    question = RichTextField(default="", blank=True)
    example = RichTextField(default=default_example, blank=True)
    hint = RichTextField(default="", blank=True)
    quiz_type = models.ForeignKey(QuizType, on_delete=models.CASCADE)
    category = models.ForeignKey(Category, on_delete=models.CASCADE)
    visible = models.BooleanField(default=True)
    answer_header = models.TextField(default="def solve(num):", blank=True)
    option1 = models.TextField(default="", blank=True)
    option2 = models.TextField(default="", blank=True)
    option3 = models.TextField(default="", blank=True)
    option4 = models.TextField(default="", blank=True)
...
class Testcase(models.Model):
    ...
    expected_stdout = models.TextField(default="", blank=True)
